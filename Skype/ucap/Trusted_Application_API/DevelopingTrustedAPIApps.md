# Developing Trusted Application API applications for Skype for Business Online
 Learn how to develop and deploy Trusted Application API applications.
...
The Trusted Application API uses Azure Active Directory (Azure AD) to provide authentication services that your application can use to obtain rights to access the service APIs. To accomplish this, your application needs to perform the following steps:
