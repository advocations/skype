...
|**Item**|**Description**|
|:-----|:-----|
|[myGroupMembership (UCWA)](myGroupMembership_ref.md)|Represents the version two of MyGroupMembershipResource (a [group (UCWA)](group_ref.md) membership of a single[contact (UCWA)](contact_ref.md))|
